...
/**
 * This is a static class of fixed colour values which provides a single point
 * of reference from where we can change colours throughout the whole
 * application.
 */
public class ColourScheme {
	...
	public static final Color HISTOGRAM_BAR = Color.BLACK;
